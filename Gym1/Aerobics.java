...
import java.util.Scanner;
  ...
  public static void aerobics(String[] args) {
  ...
  spinning.set(6, "Bokad");
   ...
   System.out.printf("Boka din plats på aerobics%n%n1A %s - 1B %s - 1C %s%n2A %s - 2B %s - 2C %s%n3A %s - 3B %s - 3C %s%n%nSkriv in vilken plats du vill boka:%n",spinning.get(0),spinning.get(1),spinning.get(2),spinning.get(3),spinning.get(4),spinning.get(5),spinning.get(6),spinning.get(7),spinning.get(8));
